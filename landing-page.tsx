        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-4 sm:space-y-6">
              ...
              <Button className="bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 text-white border-0 w-full sm:w-auto">
                GET A FREE DEMO
              </Button>
            </div>
            <div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <Card className="text-center p-4 sm:p-6 hover:shadow-lg transition-shadow bg-gray-700 border-gray-600 hover:border-purple-500/50">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2 text-white">Smart Dashboard</h3>
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="p-6 bg-gray-800 border-gray-700 hover:border-purple-500/50 transition-colors">
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="item-1" className="border border-gray-700 rounded-lg px-6 bg-gray-700">
              ...
              <AccordionContent className="text-gray-300">No</AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-2" className="border border-gray-700 rounded-lg px-6 bg-gray-700">
              ...
              <AccordionContent className="text-gray-300">Yes</AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-3" className="border border-gray-700 rounded-lg px-6 bg-gray-700">
              ...
              <AccordionContent className="text-gray-300">Book a FREE Demo to know more.</AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
      </section>
